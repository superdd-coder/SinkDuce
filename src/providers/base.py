...
class LLMProvider(ABC):
    ...
    @abstractmethod
    def generate_stream(self, prompt: str, system: str = "", temperature: float | None = None, max_tokens: int | None = None, response_format: dict | None = None, thinking: bool | None = None, thinking_effort: str | None = None): ...
